...
# Project DEPS
_DEPS = main.h config.h console.h prompt.h log.h string_utils.h utils.h robot.h event_handler.h list.h keyframe.h
DEPS = $(patsubst %,$(INC_DIR)/%,$(_DEPS))

# Server Objects
_OBJ = main.o config.o log.o console.o prompt.o string_utils.o utils.o robot.o event_handler.o list.o keyframe.o
